...
#### (Source -> MIPS64 Assemby -> Machine code (binary : hex))
...
_For more details about the C source and header files and what they do, please refer to the ReadMe.md file in the "kore-desu-1" folder_
